...
import com.keste.exception.TOEMAILNULLVALUEEXCEPTION;
...
public final class SendEmailReportUtlis {
	...
	String from = "akashsudhrsanan196@gmail.com";
	static String authKey = "nqjvbxfgpadprrwx";
	// email body
	static String subject = "Test Execution Status Report";
	static String[] toAddress = {"akashsudhrsanan196@gmail.com"};//getListOfReceipient("TOEMAILRECIPIENT");
